...
*General - Pagination for the User Plant Records and Admin Plant Records - better user experience, easier to navigate as the collection increases.
...
*Administration Only - Admin Delete option alongside the update button, to help the administrator maintain an up-to-date plant collection.
